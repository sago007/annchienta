...
if not partyManager.hasRecord("prison_awakening"):
    ...
    sceneManager.thoughts( "I can still recall we entered the building... Through a hidden passage Jelobat showed us before... We were there to steal something... I remember Vincent shouting something at me... a pendant, I think." )
    sceneManager.thoughts( "Where is the rest? Where are Christopher and Jelobat? And where is Vincent?" )
