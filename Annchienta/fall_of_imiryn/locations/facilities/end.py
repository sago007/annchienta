...
sceneManager.speak( soldier1, "General... We are receiving new reports. A fleet of sky pirates is gathering near our capital." )
...
if won:
    ...
    sceneManager.speak( august, "We did it... we killed him!" )
    sceneManager.speak( kyzano, "I know... that's good... but it's only the beginning. You have his airship now..." )
    sceneManager.speak( kyzano, "Fly to Kimen, a place north of the Imiryn Empirial City." )
    sceneManager.speak( august, "Yeah, but... I mean, we still don't know what we're fighting for..." )
    sceneManager.speak( kyzano, "Trust me, it's worth more than our empire... it's a cancer we need to destroy." )
    sceneManager.speak( kyzano, "I don't know everything myself, though..." )
