...
sceneManager.speak( banver, "First, I wanted to congratulate each of you for finishing your personal task." )
...
sceneManager.speak( banver, "She died as a warrior, Avril. You can be proud of her, and live up to that example." )

sceneManager.speak( banver, "Now, about your final task. I can be short." )
sceneManager.speak( banver, "Fishermen have recently been attacked by a terrible sea creature. Many ships haven't returned." )
sceneManager.speak( banver, "Most of the attacks happened in the Inaran region- in the very south of the Jemor continent." )
