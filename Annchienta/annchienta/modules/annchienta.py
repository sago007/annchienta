...
class VideoManager(_object):
    ...
    def getNumberOfBackBuffers(*args): return _annchienta.VideoManager_getNumberOfBackBuffers(*args)
    ...
    def push(*args): return _annchienta.VideoManager_push(*args)
    def pop(*args): return _annchienta.VideoManager_pop(*args)
...
class Layer(_object):
    ...
    def addObject(*args): return _annchienta.Layer_addObject(*args)
    def addArea(*args): return _annchienta.Layer_addArea(*args)
    def makeEmpty(*args): return _annchienta.Layer_makeEmpty(*args)
    def setTileSet(*args): return _annchienta.Layer_setTileSet(*args)
    def getTileSet(*args): return _annchienta.Layer_getTileSet(*args)
    ...
    def getNumberOfAreas(*args): return _annchienta.Layer_getNumberOfAreas(*args)
...
class Map(_object):
    ...
    def getPerson(*args): return _annchienta.Map_getPerson(*args)
...
class Entity(_object):
    ...
    def getMask(*args): return _annchienta.Entity_getMask(*args)
    def getMaskPosition(*args): return _annchienta.Entity_getMaskPosition(*args)
    def collidesWith(*args): return _annchienta.Entity_collidesWith(*args)
...
class Tile(Entity):
    ...
    def getMask(*args): return _annchienta.Tile_getMask(*args)
...
class Person(StaticObject):
    ...
    def setSpeed(*args): return _annchienta.Person_setSpeed(*args)
    def getSpeed(*args): return _annchienta.Person_getSpeed(*args)
